    ...
    public class CD_Clientes
    {
        ...
        public void insertarCliente(Cliente cliente)
        {
            ...
            try
            {
                ...
                query = "Insert Into Cliente (identificacion,nombre, apellido1, apellido2, fec_nacimiento, genero) Values(@identificacion, @nombre, @apellido1,@apellido2, @fec_nacimiento, @genero )";
        ...
        public List<Cliente> GetClienteList()
        {
            ...
            {
                conexion = new SqlConnection(cadenaConexion);
                string query = "SELECT identificacion, nombre,apellido1, apellido2, fec_nacimiento,genero FROM Cliente";
                cmd = new SqlCommand(query, conexion);
                ...
                while (dr.Read())
                {
                    clienteLista.Add(new Cliente
                    {
                        ...
                        fec_nacimiento = Convert.ToDateTime(dr["fec_nacimiento"]),
